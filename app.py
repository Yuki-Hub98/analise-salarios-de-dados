...
green_scale = ["#e6f4ee", "#6fc7a1", "#2d9f6d", "#1a6b47"]

col_graf1, col_graf2 = st.columns(2)

# -------- GRÁFICO 1 (COR AJUSTADA) --------
with col_graf1:
    if not df_filtrado.empty:
        top_cargos = (
...
with col_graf2:
    if not df_filtrado.empty:
        grafico_hist = px.histogram(
            ...
            color_discrete_sequence=["#2d9f6d"]
        )
...
with col_graf3:
    if not df_filtrado.empty:
        ...
        grafico_remoto = px.pie(
            ...
            hole=0.5,
            color_discrete_sequence=green_scale[::-1]
        )
